---
name: data-design
description: "Use for actionable CREATE work that defines physical persistence ownership, durable representation, constraints and physical transaction/isolation realization from accepted domain/application/system/concurrency-consistency/security truth."
---
...
- accepted System Architecture topology constraints;\n- accepted Concurrency/Consistency Design constraints when applicable;
...
5. Define transaction/isolation/locking/version representation where accepted Concurrency/Consistency Design semantics require a physical realization.
...
Stop when identity/lifecycle/history semantics are unresolved; cross-owner concurrency/consistency meaning is undecided; retention/protection obligations are required but absent; or a migration requires material intermediate-state decisions not owned by Data Design.
...
- transaction mechanics realize, not redefine, accepted Concurrency/Consistency Design semantics;
