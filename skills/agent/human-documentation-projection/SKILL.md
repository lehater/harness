...
description: "Research-only skill for producing source-bounded human narrative projections from a compiled Harness projection manifest and presentation plan. It must not create or repair engineering semantics."
---
